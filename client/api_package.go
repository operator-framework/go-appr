...
/*
PackageApiService Push new package release to the registry
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body Package object to be added to the registry
 * @param optional nil or *CreatePackageOpts - Optional Parameters:
 * @param "Force" (optional.Bool) -  Force push the release (if allowed)
@return Package
*/

type CreatePackageOpts struct {
	Force optional.Bool
}
...
func (a *PackageApiService) CreatePackage(ctx context.Context, body PostPackage, localVarOptionals *CreatePackageOpts) (Package, *http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/api/v1/packages"
...
func (a *PackageApiService) DeletePackage(ctx context.Context, namespace string, package_ string, release string, mediaType string) (Package, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v1/packages/{namespace}/{package}/{release}/{media_type}"
...
/*
PackageApiService List packages
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *ListPackagesOpts - Optional Parameters:
...
func (a *PackageApiService) ListPackages(ctx context.Context, localVarOptionals *ListPackagesOpts) ([]Package, *http.Response, error) {
	...
	if localVarOptionals != nil && localVarOptionals.MediaType.IsSet() {
		localVarQueryParams.Add("media_type", parameterToString(localVarOptionals.MediaType.Value(), ""))
	}
	// to determine the Content-Type header
	localVarHttpContentTypes := []string{}
...
/*
PackageApiService Download the package
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param namespace namespace
 * @param package_ package name
 * @param release release name
 * @param mediaType content type
 * @param optional nil or *PackagePullPackageOpts - Optional Parameters:
 * @param "Format" (optional.String) -  reponse format: json or blob
@return *os.File
*/

type PackagePullPackageOpts struct {
 ...
 * @param release release name
 * @param mediaType content type
 * @param optional nil or *PackagePullPackageJsonOpts - Optional Parameters:
 * @param "Format" (optional.String) -  reponse format: json or blob
@return PullJson
*/

type PackagePullPackageJsonOpts struct {
	Format optional.String
}
...
func (a *PackageApiService) ShowPackageManifests(ctx context.Context, namespace string, package_ string, release string) ([]Manifest, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v1/packages/{namespace}/{package}/{release}"
	localVarPath = strings.Replace(localVarPath, "{"+"namespace"+"}", fmt.Sprintf("%v", namespace), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"package"+"}", fmt.Sprintf("%v", package_), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"release"+"}", fmt.Sprintf("%v", release), -1)
...
/*
PackageApiService List all releases for a package
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param namespace namespace
 * @param package_ package name
 * @param optional nil or *ShowPackageReleasesOpts - Optional Parameters:
 * @param "MediaType" (optional.String) -  Filter by media-type
@return []Manifest
*/

type ShowPackageReleasesOpts struct {
	MediaType optional.String
}
...
func (a *PackageApiService) ShowPackageReleases(ctx context.Context, namespace string, package_ string, localVarOptionals *ShowPackageReleasesOpts) ([]Manifest, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v1/packages/{namespace}/{package}"
	localVarPath = strings.Replace(localVarPath, "{"+"namespace"+"}", fmt.Sprintf("%v", namespace), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"package"+"}", fmt.Sprintf("%v", package_), -1)
